...
export default function ProjectFlut({ onBack }) {
  // State untuk melacak gambar aktif di Lightbox (Pop-up)
  const [activeLightbox, setActiveLightbox] = useState(null);

  // Daftar 8 Gambar Flutter Anda (flutter2.png s.d flutter9.png) dari folder public/projects/
  const images = [
    { src: "/projects/flutter2.png", caption: "Halaman Beranda Utama Aplikasi" },      // images[0] -> Fig. 01
    { src: "/projects/flutter3.png", caption: "Halaman Detil Fitur & Layanan" },      // images[1] -> Fig. 07
    { src: "/projects/flutter4.png", caption: "Halaman Masuk Akun (Login)" },          // images[2] -> Fig. 05
    { src: "/projects/flutter5.png", caption: "Halaman Riwayat Aktivitas" },           // images[3] -> Fig. 02
    { src: "/projects/flutter6.png", caption: "Halaman Pencarian & Kategori" },        // images[4] -> Fig. 04
    { src: "/projects/flutter7.png", caption: "Halaman Menu Pengaturan Profil" },       // images[5] -> Fig. 06
    { src: "/projects/flutter8.png", caption: "Halaman Notifikasi Realtime" },          // images[6] -> Fig. 03
    { src: "/projects/flutter9.png", caption: "Halaman Alur Pembayaran Digital" }       // images[7] -> Fig. 08
  ];
  ...
  return (
    <div className="min-h-screen bg-[#fafafb] text-[#4b5563] font-sans selection:bg-[#ca5b00] selection:text-white relative overflow-hidden pb-32">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-12 md:pt-16 flex items-center justify-between">
        ...
        <span className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.2em] font-bold text-[#ca5b00]">Case Study &bull; Flutter</span>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 mt-8 md:mt-12 space-y-16">
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {["Flutter", "Dart","Android SDK"].map(t => (
        ...
        <div className="space-y-6 pt-8">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-[#4b5563] text-left">
             An interactive Android-based English learning application featuring gamified course mastery, quick practice modules, personalized progress metrics, and live announcements.</p>
        </div>
