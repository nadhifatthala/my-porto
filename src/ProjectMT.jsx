...
export default function ProjectMT({ onBack }) {
  // State untuk melacak gambar aktif di Lightbox (Pop-up)
  const [activeLightbox, setActiveLightbox] = useState(null);

  // Daftar 8 Gambar Madura Tour Anda (mt1.png s.d mt8.png) dari folder public/projects/
  const images = [
    { src: "/projects/mt1.png", caption: "Halaman Beranda & Eksplorasi Wisata Madura" }, // images[0] -> Fig. 01
    { src: "/projects/mt2.png", caption: "Halaman Detil Destinasi & Tiket Wisata" },     // images[1] -> Fig. 07
    { src: "/projects/mt3.png", caption: "Halaman Registrasi Pengguna Baru" },          // images[2] -> Fig. 05
    { src: "/projects/mt4.png", caption: "Halaman Masuk Akun (Login)" },                 // images[3] -> Fig. 02
    { src: "/projects/mt5.png", caption: "Halaman Pencarian Kuliner & Budaya" },          // images[4] -> Fig. 04
    { src: "/projects/mt6.png", caption: "Halaman Pemesanan Tour Guide Lokal" },         // images[5] -> Fig. 06
    { src: "/projects/mt7.png", caption: "Halaman Notifikasi Realtime & Chat" },         // images[6] -> Fig. 03
    { src: "/projects/mt8.png", caption: "Halaman Profil & Pengaturan Akun" }            // images[7] -> Fig. 08
  ];
  ...
  return (
    <div className="min-h-screen bg-[#fafafb] text-[#4b5563] font-sans selection:bg-[#ca5b00] selection:text-white relative overflow-hidden pb-32">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-12 md:pt-16 flex items-center justify-between">
        ...
        <span className="text-[10px] sm:text-xs font-mono uppercase tracking-[0.2em] font-bold text-[#ca5b00]">Case Study &bull; Tourism</span>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 mt-8 md:mt-12 space-y-16">
        <div>
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-[#0e121e]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Madura Tour Mobile App
          </h1>
          <div className="flex flex-wrap gap-2 mt-4">
            {["Flutter", "Dart", "Firebase", "Google Maps API", "Tailwind CSS"].map(t => (
        ...
        <div className="space-y-6 pt-8">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-[#4b5563] text-left">
            A comprehensive mobile tourism application designed to explore local destinations, cultural heritages, and culinary delights across Madura Island, providing tourists with an all-in-one digital guide.
          </p>
        </div>
