...
export default function ProjectEdu({ onBack }) {
  // State untuk melacak gambar aktif di Lightbox (Pop-up)
  const [activeLightbox, setActiveLightbox] = useState(null);

  // Daftar 7 Gambar yang dipetakan pas dengan alur rujukan gambar Anda
  const images = [
    { src: "/projects/edu1.png", caption: "Halaman Sambutan & Mulai — EduTech Madura" }, // images[0]
    { src: "/projects/edu2.png", caption: "Halaman Pendaftaran (Daftar)" },             // images[1]
    { src: "/projects/edu3.png", caption: "Halaman Masuk (Login)" },                    // images[2]
    { src: "/projects/edu4.png", caption: "Halaman Beranda Utama (Hai, Nadif!)" },       // images[3]
    { src: "/projects/edu5.png", caption: "Halaman Kategori & Eksplorasi Materi" },       // images[4]
    { src: "/projects/edu6.png", caption: "Halaman Detail Materi (Tari Sorong)" },      // images[5]
    { src: "/projects/edu2.png", caption: "Halaman Beranda Utama Versi HP" }            // images[6]
  ];
      ...
      <div className="max-w-5xl mx-auto px-6 mt-8 md:mt-12 space-y-16">
        <div>
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-[#0e121e]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Academic EduPortal & Analytics Center
          </h1>
          <div className="flex flex-wrap gap-2 mt-4">
            {["Aplikasi Mobile", "UI/UX", "Design", "Figma"].map(t => (
        ...
        <div className="space-y-6">
          ...
          {/* =========================================================================
              COLLAGE GRID ASIMETRIS (KONSISTEN 3 KOLOM DI MOBILE DAN DESKTOP)
              ========================================================================= */}
            ...
            */}
            <div className="flex flex-col gap-2 md:gap-8 pt-4 md:pt-16">
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  <span className="md:hidden">Fig. 01</span>
                  <span className="hidden md:inline">Fig. 01 &mdash; {images[1].caption}</span>
                </span>
              </div>

              {/* Fig. 02 — Beranda Utama */}
              <div 
            ...
            <div className="flex flex-col gap-2 md:gap-8 pt-0">
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  ...
                  <span className="hidden md:inline">Fig. 03 &mdash; {images[4].caption}</span>
                </span>
              </div>

              {/* Fig. 04 — Halaman Masuk (Login) */}
              <div 
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  ...
                  <span className="hidden md:inline">Fig. 04 &mdash; {images[2].caption}</span>
                </span>
              </div>

              {/* Fig. 05 — Detail Materi */}
              <div 
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  ...
                  <span className="hidden md:inline">Fig. 05 &mdash; {images[5].caption}</span>
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 md:gap-8 pt-8 md:pt-32">
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  ...
                  <span className="hidden md:inline">Fig. 06 &mdash; {images[0].caption}</span>
                </span>
              </div>

              {/* Fig. 07 — Beranda Alternatif */}
              <div 
              ...
              >
                ...
                <span className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#555555]/90 backdrop-blur-sm text-white text-[7px] md:text-[9px] font-mono px-1 md:px-3 py-0.5 md:py-1.5 rounded md:rounded-md tracking-wide shadow-md">
                  ...
                  <span className="hidden md:inline">Fig. 07 &mdash; {images[6].caption}</span>
                </span>
              </div>
            </div>
